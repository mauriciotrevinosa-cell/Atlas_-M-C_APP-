...
const modules = [
  {
    ...
    href: '/api/brain/synthesize/SPY',
    detail: 'Synthesis, analytics, factors, risk, and strategy endpoints.',
  },
  {
    label: 'ARIA',
  ...
  },
  {
    ...
    href: '/api/agents',
    detail: 'Repo maps, module summaries, symbol extraction, and graph context.',
  },
  {
    label: 'Scenario Lab',
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                    {modules.map((module) => (
                      <a
                        key={module.label}
                        href={module.href}
                        className="atlas-glass rounded-lg p-5 text-slate-800 transition hover:-translate-y-0.5"
                      >
